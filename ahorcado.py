...
def ahorcado():
    ...
    # letras que el usuario ha advinado durante el juego.
    ...
    while len(letras_por_adivinar) > 0 and vidas > 0:
        ...
        # Si la letra escogida por el usuario está en el abecedario y no está en el conjunto de letras que ya
        #  se han ingresado, se añade la letra al conjunto de letras ingresadas.
